...
API_KEY = "CYtGRhT39lkBQnWirIlVJXEWE"
API_SECRET = "s556Yt5GxHsnDj0WKwN2EAi2Yk0BTh19ajx8eUHsBQtbpk5yHS"
...
def display():
	...
	#Get auth url
	auth = twitter.get_authentication_tokens(callback_url='http://54.173.95.142/twitterfinish')
